...
ALSO contains Telegram payment notification functions (preserved from original module).
"""
...
# ---------------------------------------------------------------------------
# Telegram payment notification functions (preserved from original module)
# ---------------------------------------------------------------------------
